...
export default class TodayScheduleFragment extends Component {
    state = {
    ...
    async fetchData(page){
        ...
        let body = {
            ...
            beginTs: moment.utc().startOf('day').unix()*1000,
            endTs: moment.utc().endOf('day').unix()*1000,
        };
    ...
    renderOperator(){
        ...
        return (<View style={styles.operator}>
            ...
            <TouchableOpacity activeOpacity={0.6} onPress={() => {Actions.push('scheduleFilter', {type: enumSelector.scheduleType.TODAY})}}>
