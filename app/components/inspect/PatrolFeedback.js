...
export default class PatrolFeedback extends Component {
    constructor(props) {
        super(props);
    }
                ...
                if(item.mediaType === 1){
                    ...
                    return (
                        <TouchableOpacity style={{marginBottom: 15,height: 75,width:93,marginRight:10}}
                           onPress={() => this.viewPicture(item.mediaPath)}>
                       <Image style={{width:93,height:75}} source={{uri: item.mediaPath}} resizeMode='stretch'/>
                      </TouchableOpacity>
                    );
                }
            });
