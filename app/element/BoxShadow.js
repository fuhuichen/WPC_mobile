...
export default class BoxShadow extends Component {
    render = () => {
        ...
        let { setting:{width=0,height=0,color="#000",border=0,radius=0,opacity=1,x=0,y=0,style={}}, children } = this.props
        ...
        return (
            <View style={[{position:"relative",width:width,height:height,marginLeft: marginLeft},style]}>
