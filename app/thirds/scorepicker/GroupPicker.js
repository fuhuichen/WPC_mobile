...
export default class GroupPicker extends React.Component<Props, State> {
    ...
    render() {
        ...
        let scrollIndex = (initIndex > 0 && initIndex < (data.length-1)) ? (initIndex-1) : initIndex;
        ...
        return (
            <View>
                <ModalBox style={styles.modalBox} ref={"modalBox"}  position={"center"}
                    ...
                    <Text style={styles.timeLabel}>{I18n.t('Patrol category')}</Text>
