...
public class WebRTCView extends ViewGroup {
    private class ProxyVideoSink implements VideoSink {
      ...
      //  Logging.d(TAG, "setTarget, target:"+(null !=target ?target.toString():""));
        this.target = target;
    //    Logging.d(TAG, "setTarget, this.target:"+(null !=this.target ?this.target.toString():""));
      }
      ...
      //    Logging.d(TAG, "Dropping frame in proxy because target is null.");
          //VideoRenderer.renderFrameDone(videoFrame);
          return;
        }
    ...
    private void tryAddRendererToVideoTrack() {
        Log.e(TAG,"tryAddRendererToVideoTrack");
