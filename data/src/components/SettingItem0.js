...
export default class SettingItem extends React.Component {
  ...
  renderContent(){
    ...
    if( type != 'time'){
      var dataColor = {width:this.props.width-70,textAlign:'center',color:VALUES.COLORMAP.dkk_font_white}
      ...
      if(type == 'input'){
        ...
        return (
            <TouchableOpacity onPress={this.props.onPress}  style={[styles.normalContent,{width:this.props.width}]}>
  ...
  render () {
    ...
    if(this.props.index){
      return (<View style={[{alignItems:'flex-start',width:this.props.width,paddingLeft:10,paddingRight:10}]}>
                  <View style={[styles.viewStyle,{marginTop:0,borderBottomColor:'#555555',borderBottomWidth:0.5}]}>
                      {this.renderContent()}
                      {this.renderButton()}
                  </View>
             </View>);
    ...
    return (<View style={[{flex:1,flexDirection:'row',alignItems:'center',width:this.props.width}]}>
